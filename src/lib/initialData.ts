...
export const INITIAL_DOCUMENTS: ClubDocument[] = [
  ...
  {
    id: 'doc-5',
    title: 'Resolución de Reconocimiento Deportivo Inder Sabaneta N° 042-2024',
    description: 'Documento legal formal expedido por el Instituto de Deportes y Recreación de Sabaneta avalando la personería deportiva del club.',
    file_url: '#',
    file_type: 'pdf',
    file_size: '2.4 MB',
    category: 'Resolución',
  ...
  {
    id: 'doc-6',
    title: 'Guía Integral del Deportista Afiliado y Plataformas Virtuales',
    description: 'Manual paso a paso para el uso del tablero Lichess, estudio de aperturas, control de asistencia y carnet digital.',
    file_url: '#',
    file_type: 'pdf',
    file_size: '3.1 MB',
    category: 'Guía',
  ...
  {
    id: 'doc-7',
    title: 'Formulario de Inscripción y Consentimiento Deportivo 2026',
    description: 'Ficha médica deportiva, autorización de menores de edad y registro de acudiente para competencias oficiales.',
    file_url: '#',
    file_type: 'pdf',
    file_size: '1.2 MB',
    category: 'Formulario de inscripción',
    min_role: 'student',
    downloads_count: 102,
  ...
  {
    id: 'doc-8',
    title: 'Acta de Asamblea General Ordinaria 2026',
    description: 'Resumen ejecutivo de acuerdos, presupuesto anual aprobado y plan de acción de la Junta Directiva.',
    file_url: '#',
    file_type: 'pdf',
    file_size: '1.5 MB',
    category: 'Acta',
...
export const INITIAL_PAYMENTS: MembershipPayment[] = [
  ...
  },
  {
    ...
    user_name: 'Andrés Arboleda',
    user_email: 'andres.arboleda@gmail.com',
    amount: 120000,
    payment_date: '2026-09-05',
    payment_method: 'Nequi',
    reference_number: 'NQ-881204',
    period: 'Septiembre 2026',
    status: 'pending',
    notes: 'Comprobante transferido por Nequi',
  ...
  },
  {
    ...
    reference_number: 'DP-001294',
    period: 'Agosto 2026',
    status: 'rejected',
    reviewed_by: 'usr-admin-01',
    reviewed_at: '2026-08-02T09:15:00Z',
    rejection_reason: 'El comprobante adjunto estaba cortado y no se apreciaba el valor transferido ni la fecha exacta.',
    notes: 'Comprobante borroso',
...
export const MOCK_ADMIN_PROFILE: UserProfile = {
  ...
  elo_rating: 2150,
  lichess_username: 'capablanca_admin',
  estado: 'active',
...
export const MOCK_MEMBER_PROFILE: UserProfile = {
  ...
  elo_rating: 1580,
  fide_id: '4452190',
  lichess_username: 'santiago_capablanca',
  estado: 'active',
...
export const INITIAL_MEMBERS: UserProfile[] = [
  ...
  MOCK_MEMBER_PROFILE,
  {
    ...
    elo_rating: 1520,
    fide_id: '4452205',
    lichess_username: 'andres_arboleda',
    estado: 'active',
    created_at: '2025-03-01T00:00:00Z',
  },
  {
